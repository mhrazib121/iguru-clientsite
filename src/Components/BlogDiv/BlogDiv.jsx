  ...
  return (
    <div className="w-3/5 mt-12 mx-auto">
      ...
      <div className="md:flex   w-full gap-8  mx-auto">
        <div
          className="w-full mx-auto mb-8 md:mb-0"
          data-aos="fade-right"
          data-aos-offset="400"
        >
          ...
          <p className="text-sm font-semibold mt-4">
            {demoData[0].date} / 0 Comments
          </p>
          <Link
            href="#"
            className="text-2xl font-semibold hover:text-orange-600 cursor-pointer"
          >
            {" "}
            {demoData[0].title}{" "}
          </Link>
        </div>
        <div className=" w-5/6" data-aos="fade-left" data-aos-offset="300">
            ...
            <div key={blog.id} className="flex gap-4 mb-4">
              ...
              <div className="my-auto">
                <p className="text-[12px] font-semibold mb-2">
                  {blog.date} / 0 Comments
                </p>
                <Link
                  href="#"
                  className="text-lg font-semibold hover:text-orange-600 cursor-pointer"
                >
                  {" "}
                  {blog.title}{" "}
                </Link>
