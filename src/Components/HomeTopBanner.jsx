...
const HomeTopBanner = () => {
    ...
    return (
        <div className="w-3/5 mx-auto  hero min-h-screen"
            data-aos='fade-down'
            data-aos-delay='1200'
        >
            <div className="hero-content pb-0 flex-col lg:flex-row-reverse ">
                <Image src={Feature1} alt="learner" className="max-w-[300px] md:max-w-[520px]  rounded-lg " />
                <div className=''>
                    <span className={`p-2 text-lg leading-8 rounded-md text-[${color.primary}]`}> LEARN ANYTIME, LEARN ANYTHING</span> <br /> <br />
                    <h1 className="text-5xl font-bold" data-aos="fade-zoom-in" data-aos-duration="600" >We Give You The Perfect Smile You Wanted</h1>
