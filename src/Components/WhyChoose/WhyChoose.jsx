...
import { BsRocketTakeoff, BsStar } from "react-icons/bs";
...
const WhyChoose = memo(function WhyChoose() {
  ...
  return (
    <div
      className="p-0 max-w-[1000px] mx-auto"
      data-aos="fade-down"
      data-aos-delay="300"
    >
      ...
      <p className="text-orange-600 text-md font-semibold mb-4 text-center">
        Simple Reasons
      </p>
      <div className="relative">
        <Image
          className=" hidden lg:flex w-[320px] absolute bottom-0 left-[50%] right-[50%] -ml-36"
          src={Person}
          alt="people"
        />
        <div className=" grid grid-cols-1 md:grid-cols-2 my-12">
          {demoData.map((data, index) => (
            ...
            >
              <div
                className=" text-orange-600 text-5xl hover:text-black
